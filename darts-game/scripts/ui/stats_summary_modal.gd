...
func show_summary_data(title: String, meta_text: String, stats_rows: Array[Dictionary], breakdown_rows: Array[Dictionary], continue_match: bool, player_name: String = "PLAYER", ai_name: String = "AI") -> void:
...
func _populate_summary_table(rows: Array[Dictionary]) -> void:
	...
	_add_cell(table, _player_name, 210.0, SUMMARY_ROW_HEIGHT, HEADER_COLOR, MUTED_TEXT_COLOR, 14, HORIZONTAL_ALIGNMENT_CENTER)
	_add_cell(table, _ai_name, 210.0, SUMMARY_ROW_HEIGHT, HEADER_COLOR, MUTED_TEXT_COLOR, 14, HORIZONTAL_ALIGNMENT_CENTER)
